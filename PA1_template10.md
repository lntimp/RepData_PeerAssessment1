...
## #   `325` <dbl>, `330` <dbl>, `335` <dbl>, `340` <dbl>, `345` <dbl>, …
```
...
![](PA1_template10_files/figure-html/unnamed-chunk-7-1.png)<!-- -->
...
![](PA1_template10_files/figure-html/unnamed-chunk-9-1.png)<!-- -->
...
![](PA1_template10_files/figure-html/unnamed-chunk-13-1.png)<!-- -->
...
```
## Warning: There were 576 warnings in `mutate()`.
...
## ℹ Run `dplyr::last_dplyr_warnings()` to see the 575 remaining warnings.
```
...
```
##   [1] 5.043396e+00 2.146226e-01 1.222905e+00 6.792453e-02 4.245283e-02
...
## [861] 3.053971e-01 2.150943e-01 1.344340e-01 1.450636e+00
```
...
![](PA1_template10_files/figure-html/unnamed-chunk-16-1.png)<!-- -->
